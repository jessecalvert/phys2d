/*@H
* File: phys2d_debug_interface.h
* Author: Jesse Calvert
* Created: October 9, 2017, 11:44
* Last modified: November 27, 2017, 15:25
*/

#pragma once

#define DEBUG_FRAME_END(Name) void Name(game_memory *Memory, game_input *Input, u64 CountsPerSecond)
...
#define RECORD_DEBUG_EVENT(GUIDInit, TypeInit) \
	...
	debug_event *Event = GlobalDebugTable->DebugEvents[GlobalDebugTable->ArrayIndex] + GlobalDebugTable->EventCount; \
	GlobalDebugTable->EventCount += GlobalDebugTable->Recording ? 1 : 0; \
	Event->GUID = GUIDInit; \
	Event->Type = TypeInit; \
	Event->Tick = __rdtsc();
